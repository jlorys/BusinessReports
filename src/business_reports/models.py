...
class Parameter(AuditableTable):
    ...
    def edit_link(self):
        return mark_safe("<a href='/admin/business_reports/parameter/%s/'>Edit</a>" % self.id)
...
class DataSet(AuditableTable):
    ...
    def edit_link(self):
        return mark_safe("<a href='/admin/business_reports/dataset/%s/'>Edit</a>" % self.id)
...
class Report(AuditableTable):
    ...
    def get_absolute_url(self):
        return reverse('business_reports.views.report', args=[str(self.id)])
