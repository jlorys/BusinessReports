...
SECRET_KEY = 'vw$pg-#qab-ga85q--c((1152tnu=q6$izc_sgccxylw%#(^yt'
...
MR_REPORTS_WKHTMLTOPDF_PATH = 'C:/Program Files/wkhtmltopdf/bin/wkhtmltopdf.exe'
MR_REPORTS_WKHTMLTOPDF_OPTIONS = [
    '--javascript-delay', '1000',
]

BASE_PATH = 'http://0.0.0.0:8069/' #instead of http://10.101.10.172:8002/, because now it works faster